# [1329. Sort the Matrix Diagonally][link] (Medium)

[link]: https://leetcode.cn/problems/sort-the-matrix-diagonally/
...
example, the **matrix diagonal** starting from `mat[2][0]`, where `mat` is a `6 x 3` matrix,
